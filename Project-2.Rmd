...
Our final model is the `r modelChosen`. When we fit the model on the test data we get RMSE=`r finalModel[1, 1]`,  Rsquared=`r testResult[2, 1]`, and MAE=`r testResult[3, 1]`.
