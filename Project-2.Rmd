...
After completing EDA, we will describe and demonstrate building 4 predictive models: 2 linear regression models and 2 ensemble models (Random Forest and Boosted Tree). Finally, we will select the model that has the lowest root mean square error (RMSE).
